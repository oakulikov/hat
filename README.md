...
Репозиторий содержит пять основных учебных курсов:
...
### 5. Учебное пособие по линзам (lens-tutorial/)
...
5. Наконец, перейдите к линзам, которые предоставляют удобный способ работы с вложенными структурами данных
...
5. **Примеры с линзами** (lens-tutorial/) - требуют установки библиотеки lens и других зависимостей.
